...
<main class="fv">
  <div class="fv-img">
    <img class="fv-img-img" src="img/name-kakimoto1.png" alt="">
  </div>
</main>
...
<section class="name inner">
  <div class="name-flex">
    ...
    <figure class="name-flex-right fade-in fade-in-up">
      ...
      <img class="name-flex-right-img" src="img/name-kakimoto2.png" alt="">
    </figure>
  </div>
</section>
...
<section class="dayoff">
  ...
  <div class="dayoff-flex inner">
    <div class="dayoff-flex-container fade-in fade-in-up">
      <img src="img/name-card4.png" alt="">
    ...
    <div class="dayoff-flex-container fade-in fade-in-up">
      <img src="img/name-card5.png" alt="">
      <div class="dayoff-flex-container-desc">
    ...
    <div class="dayoff-flex-container fade-in fade-in-up">
      <img src="img/name-card6.png" alt="">
      <div class="dayoff-flex-container-desc">
...
<section class="next">
  <div class="next-flex">
    ...
    <a href="nakama.html" class="next-flex-link fade-in fade-in-left">
      <img src="img/name-next-nakama.png">
    </a>
