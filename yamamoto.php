...
<main class="fv">
  <div class="fv-img">
    <img class="fv-img-img" src="img/name-yamamoto1.png" alt="">
  </div>
</main>
...
<section class="name inner">
  <div class="name-flex">
    ...
    <figure class="name-flex-right fade-in fade-in-up">
      ...
      <img class="name-flex-right-img" src="img/name-yamamoto2.png" alt="">
    </figure>
  </div>
</section>
...
<section class="next">
  <div class="next-flex">
    ...
    <a href="kakimoto.html" class="next-flex-link fade-in fade-in-left">
      <img src="img/name-next-kakimoto.png">
    </a>
