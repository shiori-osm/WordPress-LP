...
<section class="privacy">
  <div class="section-title">
    <h2 class="section-title-main">プライバシーポリシー</h2>
    <p class="section-title-sub">Privacy</p>
  </div>

  <div class="privacy-desc inner60">
    <h3 class="privacy-desc-title">プライバシーポリシー</h3>
    <p class="">株式会社estra（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
