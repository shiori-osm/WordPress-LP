<?php
/*
Template Name: interview-komiya
*/
?>
...
<main class="fv">
  <div class="fv-img">
    <img class="fv-img-img" src="<?php echo get_theme_file_uri("img/name-komiya1.png"); ?>" alt="">
  </div>
</main>
  ...
  <div class="name-flex">
    <div class="name-flex-left">
      <div class="name-flex-left-box">
        <p class="name-flex-left-box-title">技術開発部/開発チーム</p>
        <p class="name-flex-left-box-name">小宮吾郎</p>
        <p class="name-flex-left-box-join">2020年10月中途入社</p>
        <p>部下からの信頼も厚い、開発チームリーダー。<br>2児のパパ。</p>
      </div>
    ...
    <figure class="name-flex-right ">
      <figcaption class="name-flex-right-caption">撮影場所：株式会社estra 会議室窓辺</figcaption>
      <img class="name-flex-right-img" src="<?php echo get_theme_file_uri("img/name-komiya2.jpg"); ?>" alt="">
    </figure>
  </div>
</section>
  ...
  <div class="dayoff-flex inner">
    <div class="dayoff-flex-container">
      ...
      <div class="dayoff-flex-container-desc">
        <h3 class="dayoff-flex-container-desc-title">家族との時間は宝物</h3>
...
<section class="next">
  <div class="next-flex">
    ...
    <a href="<?php echo home_url("interview6-shiraishi"); ?>" class="next-flex-link">
      <img src="<?php echo get_theme_file_uri("img/name-next-shiraishi.png"); ?>">
    </a>
