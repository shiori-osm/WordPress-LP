<?php
/*
Template Name: interview-nakama
*/
?>
...
<main class="fv">
  <div class="fv-img">
    <img class="fv-img-img" src="<?php echo get_theme_file_uri("img/name-nakama1.png"); ?>" alt="">
  </div>
</main>
  ...
  <div class="name-flex">
    <div class="name-flex-left">
      <div class="name-flex-left-box">
        <p class="name-flex-left-box-title">マーケティング部/広告運用チーム</p>
        <p class="name-flex-left-box-name">仲間次郎</p>
        <p class="name-flex-left-box-join">2020年10月中途入社</p>
        <p>入社1年目の期待のエース。<br>3児のパパ。</p>
      </div>
    ...
    <figure class="name-flex-right">
      <figcaption class="name-flex-right-caption">撮影場所：株式会社estra 会議室</figcaption>
      <img class="name-flex-right-img" src="<?php echo get_theme_file_uri("img/name-nakama2.png"); ?>" alt="">
    </figure>
  </div>
</section>
...
<section class="next">
  <div class="next-flex">
    ...
    <a href="<?php echo home_url("interview4-yamaguchi"); ?>" class="next-flex-link">
      <img src="<?php echo get_theme_file_uri("img/name-next-yamaguchi.png"); ?>">
    </a>
