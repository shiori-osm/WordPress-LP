...
<main class="fv">
  <div class="fv-img">
    <img class="fv-img-img" src="img/name-nakama1.png" alt="">
  </div>
</main>
...
<section class="name inner">
  <div class="name-flex">
    ...
    <figure class="name-flex-right fade-in fade-in-up">
      ...
      <img class="name-flex-right-img" src="img/name-nakama2.png" alt="">
    </figure>
  </div>
</section>
...
<section class="dayoff">
  ...
  <div class="dayoff-flex inner">
    <div class="dayoff-flex-container fade-in fade-in-up">
      <img src="img/name-card1.png" alt="">
    ...
    <div class="dayoff-flex-container fade-in fade-in-up">
      <img src="img/name-card2.png" alt="">
      <div class="dayoff-flex-container-desc">
    ...
    <div class="dayoff-flex-container fade-in fade-in-up">
      <img src="img/name-card3.png" alt="">
      <div class="dayoff-flex-container-desc">
...
<section class="next">
  <div class="next-flex">
    ...
    <a href="yamaguchi.html" class="next-flex-link fade-in fade-in-left">
      <img src="img/name-next-yamaguchi.png">
    </a>
