<?php
/*
Template Name: interview-shiraishi
*/
?>
...
<main class="fv">
  <div class="fv-img">
    <img class="fv-img-img" src="<?php echo get_theme_file_uri("img/name-shiraishi1.png"); ?>" alt="">
  </div>
</main>
  ...
  <div class="name-flex">
    <div class="name-flex-left">
      <div class="name-flex-left-box">
        <p class="name-flex-left-box-title">営業戦略部/営業第二チーム</p>
        <p class="name-flex-left-box-name">白石光代</p>
        <p class="name-flex-left-box-join">2019年11月中途入社</p>
        <p>部下からの信頼も厚い人事部部長。<br>2児のママ。</p>
      </div>
    ...
    <figure class="name-flex-right">
      <figcaption class="name-flex-right-caption">撮影場所：株式会社estra エントランス</figcaption>
      <img class="name-flex-right-img" src="<?php echo get_theme_file_uri("img/name-shiraishi2.png"); ?>" alt="">
    </figure>
  </div>
</section>
...
<section class="dayoff">
  ...
  <div class="dayoff-flex inner">
    <div class="dayoff-flex-container">
      <img src="<?php echo get_theme_file_uri("img/name-card4.png"); ?>" alt="">
      <div class="dayoff-flex-container-desc">
        <h3 class="dayoff-flex-container-desc-title">家族との時間が宝物</h3>
        <p class="dayoff-flex-container-desc-p">サンプルテキストが入りますサンプルテキストが入りますサンプルテキストが入りますサンプルテキストが入ります</p>
      </div>
    </div>
    <div class="dayoff-flex-container">
      <img src="<?php echo get_theme_file_uri("img/name-card5.png"); ?>" alt="">
      <div class="dayoff-flex-container-desc">
        <h3 class="dayoff-flex-container-desc-title">健康は食事から</h3>
        <p class="dayoff-flex-container-desc-p">サンプルテキストが入りますサンプルテキストが入りますサンプルテキストが入りますサンプルテキストが入ります</p>
      </div>
    </div>
    <div class="dayoff-flex-container">
      <img src="<?php echo get_theme_file_uri("img/name-card6.png"); ?>" alt="">
      <div class="dayoff-flex-container-desc">
        <h3 class="dayoff-flex-container-desc-title">ヨガ、はじめました</h3>
        <p class="dayoff-flex-container-desc-p">サンプルテキストが入りますサンプルテキストが入りますサンプルテキストが入りますサンプルテキストが入ります</p>
      </div>
    </div>
  </div>
...
<section class="next">
  <div class="next-flex">
    ...
    <a href="<?php echo home_url("interview1-yamamoto"); ?>" class="next-flex-link">
      <img src="<?php echo get_theme_file_uri("img/name-next-yamamoto.png"); ?>">
    </a>
