<?php
/*
Template Name: interview-kakimoto
*/
?>
...
<main class="fv">
  <div class="fv-img">
    <img class="fv-img-img" src="<?php echo get_theme_file_uri("img/name-kakimoto1.png"); ?>" alt="">
  </div>
</main>
  ...
  <div class="name-flex">
    <div class="name-flex-left">
      <div class="name-flex-left-box">
        <p class="name-flex-left-box-title">人事部/広報チーム</p>
        <p class="name-flex-left-box-name">柿本珠子</p>
        <p class="name-flex-left-box-join">2019年1月中途入社</p>
    ...
    <figure class="name-flex-right">
      ...
      <img class="name-flex-right-img" src="<?php echo get_theme_file_uri("img/name-kakimoto2.png"); ?>" alt="">
    </figure>
  </div>
</section>
...
<section class="next">
  <div class="next-flex">
    ...
    <a href="<?php echo home_url("interview3-nakama"); ?>" class="next-flex-link">
      <img src="<?php echo get_theme_file_uri("img/name-next-nakama.png"); ?>">
    </a>
