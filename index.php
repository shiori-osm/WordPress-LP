...
<?php get_header(); ?>
<main class="fv">
  <img class="fv-img" src="<?php echo get_theme_file_uri("img/index-main.png"); ?>" alt="">
  <img class="fv-sp-img" src="<?php echo get_theme_file_uri("img/indexメインsp.png"); ?>" alt="">
  <div class="fv-desc">
    <p class="fv-desc-en">Commit to the growth for everyone</p>
    <p class="fv-desc-ja">全ての人の成長にコミットする</p>
  </div>
  <a href="" class="fv-news">
    <p class="fv-news-title"><span class="fv-news-title-en">News</span><span>新代々木オフィス昨年12月に移転しました</span></p>
  </a>
</main>
<section class="techcoach">
  <div class="inner">
    ...
    <div class="techcoach-flex technology">
      ...
      <div class="techcoach-flex-desc fade-in fade-in-up">
        <div class="desc">
          <h3 class="techcoach-flex-desc-title">Technology</h3>
          <p class="techcoach-flex-desc-p">株式会社estraは<br>デジタル化が遅れている教育業界に<br>
    ...
    <div class="techcoach-flex">
      <div class="techcoach-flex-desc fade-in fade-in-up">
        <div class="desc">
          <h3 class="techcoach-flex-desc-title">Coaching</h3>
          <p class="techcoach-flex-desc-p">独自のオペレーションと<br>コーチングを融合した
            新しい教育の仕組みにより、<br>
...
<section class="contact">
  <div class="section-title fade-in fade-in-up">
